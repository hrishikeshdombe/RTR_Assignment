...
void display(void)
{
	...
	glViewport(0, giHeight * 5 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_1();
	glViewport(0, giHeight * 4 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_2();
	glViewport(0, giHeight * 3 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_3();
	glViewport(0, giHeight * 2 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_4();
	glViewport(0, giHeight * 1 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_5();
	glViewport(0, 0, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_6();
	glViewport(giWidth / 4, giHeight * 5 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_7();
	glViewport(giWidth / 4, giHeight * 4 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_8();
	glViewport(giWidth / 4, giHeight * 3 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_9();
	glViewport(giWidth / 4, giHeight * 2 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_10();
	glViewport(giWidth / 4, giHeight * 1 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_11();
	glViewport(giWidth / 4, 0, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_12();
	glViewport(giWidth / 2, giHeight * 5 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_13();
	glViewport(giWidth / 2, giHeight * 4 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_14();
	glViewport(giWidth / 2, giHeight * 3 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_15();
	glViewport(giWidth / 2, giHeight * 2 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_16();
	glViewport(giWidth / 2, giHeight * 1 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_17();
	glViewport(giWidth / 2, 0, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_18();
	glViewport((giWidth /2) + (giWidth /4), giHeight * 5 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_19();
	glViewport((giWidth / 2) + (giWidth / 4), giHeight * 4 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_20();
	glViewport((giWidth / 2) + (giWidth / 4), giHeight * 3 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_21();
	glViewport((giWidth / 2) + (giWidth / 4), giHeight * 2 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_22();
	glViewport((giWidth / 2) + (giWidth / 4), giHeight * 1 / 6, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_23();
	glViewport((giWidth / 2) + (giWidth / 4), 0, (GLsizei)giWidth / 4, (GLsizei)giHeight / 4);
	Draw_Sphere_24();
