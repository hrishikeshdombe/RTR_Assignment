...
GLuint gTexture_Smiley,gTexture_White;

int giSmileyTweakFlag;
...
void CreateWindow(void)
{
	...
	XStoreName(gpDisplay,gWindow,"PP : Smiley Tweak");
...
void initialize(void)
{
	...
	void LoadGLTextures_Procedural(void);
	void resize(int,int);
...
void display(void)
{
	...
	if(giSmileyTweakFlag==1 || giSmileyTweakFlag==2 || giSmileyTweakFlag==3 || giSmileyTweakFlag==4)
